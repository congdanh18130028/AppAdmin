...
public class EditProductNameActivity extends AppCompatActivity {
    private int ID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edt = findViewById(R.id.txt_value_name_edit);
        btn = findViewById(R.id.btn_save_name_edit);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String newName = edt.getText().toString().trim();
                ProductEdit pEdit = new ProductEdit(newName, "/name", "replace");
