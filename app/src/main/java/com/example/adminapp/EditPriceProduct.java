...
public class EditPriceProduct extends AppCompatActivity {
    private int ID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_price_product);
        Intent intent = getIntent();
        ID = intent.getIntExtra("ID", 0);
        edt = findViewById(R.id.txt_value_price_edit);
        btn = findViewById(R.id.btn_save_price_edit);
